...
--drop table GroupException;
--drop table Group;
--drop table Implementation;
--drop table Course;
--drop table ContactLesson;
--drop table Classroom;
--drop table Equipment;
--drop table Teacher;
--drop table TeacherException; 
--drop table Lecture;

--These SQL statements seem to work with MySQL
...
-- INSERT INTO Course (CourseName, GrupID, StartDate, AmountWeeks, AmountLessons) VALUES ('', '', '', '', ''); 

-- --Add a lesson

-- INSERT INTO ContactLesson (LessonName) VALUES ('');

-- --Add group exceptions

-- INSERT INTO GrupException (GrupID, UnavailableDate) VALUES ('', '');

-- --Add teacher exceptions

-- INSERT INTO TeacherException (TeacheID, UnavailableDate) VALUES ('', '');

-- --HAve a list of group available to add them to the courses

-- SELECT GrupID, GrupName FROM Grup